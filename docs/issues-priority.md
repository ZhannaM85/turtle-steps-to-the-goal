...
| [#928](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/928) | 📋 Open | PDF export: vertically center page, section, and table headers | Device PDF 2026-09-16 still not centered. Extra top padding made table cells worse (text sits lower). Titles still hug the top of their bars. |
...
| [#931](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/931) | 🔍 Pending validation | PDF diary: replace unclear steps icon with a text label | Metrics header now shows the localized Шаги/Steps label beside the count. Awaiting device PDF validation. |
...
| [#933](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/933) | 🔍 Pending validation | PDF layout preview route for browser inspection | `/settings/pdf-layout` renders the same HTML+CSS as the PDF. Open from Settings → Preview layout. Awaiting browser confirmation. |
