...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#771](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/771) | 🔍 Pending validation | AutoSleep Today screenshot fill: deep sleep 7h 10m instead of 45 minutes (z icon) | Browser 2026-08-29: confirm dialog 9h 22m / 0h 45m. Real OCR glues z-icon onto `SLEEP BANK @0h45m`. 800px + hard B/W threshold turned that into `O0h asm`; grayscale invert + max edge 1600. |
