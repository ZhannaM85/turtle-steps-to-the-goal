...
| [#934](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/934) | 🔍 Pending validation | Day: Complete the day 5-week weight projection | Full-height sheet, X only. Mifflin–St Jeor TDEE already in the app; 35-day sim recalculates TDEE as weight moves; skip unusually low/high days. Formula TDEE for V1, not observed-history. Awaiting on-device confirmation. |
