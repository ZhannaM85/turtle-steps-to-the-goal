...
| [#26](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/26) | ✅ Done | Favicon reads as a 6-pointed star, not a turtle — redesign | Side-profile green (Sage `#4c7a62`) turtle facing right; asymmetry fixes the star misread from #22's top-down design |
| [#27](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/27) | ⬜ Open | Favicon still misreads (VW Beetle silhouette) — move away from turtle | Two literal-turtle attempts (#22, #26) both collapsed into unrelated shapes at favicon scale. Direction decided: weighing-scale icon, ready to implement |
