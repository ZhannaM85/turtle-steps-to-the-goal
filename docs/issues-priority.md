...
| [#935](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/935) | 📋 Not started | PDF layout preview cannot predict the iOS PDF | Chrome iframe paints CSS; export photographs via html2canvas in Safari. Table rows, meal grid, notes, footer still broken on device while the mock looks fine. |
