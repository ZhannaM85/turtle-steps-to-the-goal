...
| [#749](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/749) | 📋 Not started | Settings toggle to turn off fill-from-screenshot | Screenshot OCR has no Settings opt-out (#742 button shows whenever body composition is tracked). One What-to-track toggle for the capability (default on); off hides Zepp and future AutoSleep (#748) buttons without turning off the fields. |
