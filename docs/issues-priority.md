...
| [#933](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/933) | 🔍 Pending validation | PDF layout preview route for browser inspection | `/settings/pdf-layout` renders the same HTML+CSS as the PDF, with each page as a separate sheet and a dashed capture cutoff. Awaiting browser confirmation. |
