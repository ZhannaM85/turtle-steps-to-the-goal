...
| [#928](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/928) | 🔍 Pending validation | PDF export: vertically center page, section, and table headers | HTML preview: day header `padding: 4pt 9pt`; section titles `10.5pt` with `6pt` padding. Table cells still use extra top padding. iOS PDF 2026-09-16 still shows huge weekly-table rows vs the compact Chrome mock. |
| [#929](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/929) | 📋 Open | PDF diary: reduce Metrics and Notes body text size | Device PDF 2026-09-16 still shows Показатели and Заметки body text at the same size. |
| [#930](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/930) | 📋 Open | PDF diary: show total water beside the Water title | Device PDF 2026-09-16 puts the total at the far right of the Вода bar instead of next to the title. |
| [#932](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/932) | 📋 Not started | PDF diary: footer still cut off, generated date not visible | Device preview: diary page footer is clipped; the generated date is not visible. Logged only; no implementation started. |
| [#933](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/933) | 🔍 Pending validation | PDF layout preview route for browser inspection | `/settings/pdf-layout` renders the same HTML+CSS as the PDF, with each page as a separate sheet and a dashed capture cutoff. Chrome iframe only — does not run html2canvas (see #935). Awaiting browser confirmation. |
| [#935](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/935) | 🔍 Pending validation | PDF layout preview cannot predict the iOS PDF | Preview now photographs pages with the same html2canvas path as export. CSS avoids grid/flex-gap/asymmetric table padding. Awaiting on-device confirmation. |
| [#937](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/937) | 📋 Not started | Complete the day chart: lighten the dashed grid | #936 follow-up. Mesh is visible but a bit too dark; keep week / 500 g spacing. |
| [#938](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/938) | 📋 Not started | Complete the day chart: x-axis labels are cut off | #936 follow-up. Сегодня and 5 недель clip at the chart edges. |
