...
| [#587](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/587) | 🔍 Pending validation | Dashboard: scrolling down shows Something went wrong error | Regression from #581: always forcing fresh padded Recharts `domain` tuples on correlation scatters. Fix: omit domain when unzoomed (unless override); memoize tuples; restore NightEating X −0.5..1.5. |
