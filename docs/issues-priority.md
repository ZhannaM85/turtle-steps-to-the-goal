...
| [#930](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/930) | 🔍 Pending validation | PDF diary: show total water beside the Water title | Water total now sits in the section header beside Вода; sip rows stay in the body. Awaiting device PDF validation. |
