...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#911](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/911) | ⬜ Open | PDF diary Food section: show consumed macro totals | Add protein, fat, and carbohydrate totals alongside consumed kcal in the readable PDF diary Food section. |
