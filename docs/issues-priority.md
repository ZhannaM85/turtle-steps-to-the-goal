...
| [#650](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/650) | 🔲 Open | History: "Edit this day" button doesn't navigate to that day | Reported live with a screenshot. Tapping "Edit this day" on an expanded History day should navigate to the Day screen for that date; currently stays on History with no visible effect. Plain change request, unrelated to today's #304 work. Root cause not yet investigated |
