...
| [#969](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/969) | 🔍 Pending validation | Add meal: suggest brands from past entries | Shipped; awaiting on-device confirmation. Brand field typeahead uses stored library + meal-history brands (deduped, recent first), not a global food DB. |
