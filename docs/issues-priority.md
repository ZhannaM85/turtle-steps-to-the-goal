...
| [#682](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/682) | ⬜ Open | Past Targets: Aug 4–9 goal marked not reached despite Aug 8 weigh-in meeting 0.2 kg target | On-device: Past Targets shows 4–9 Aug 0.2 kg/week as not reached with **58.75 → 58.65**; Day page for **8 Aug** has weight **58.4** (from 58.75 / need ≤58.55). Root cause not investigated yet. |
