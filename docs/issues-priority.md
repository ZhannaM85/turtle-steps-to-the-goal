...
| [#868](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/868) | 📋 Not started | Split remaining Day/export/settings god files (≤500) | Follow-up to #864 lint. Partial: Zepp/AH/MFP extracted (`*ImportPanel` + `ThirdPartyImportSection`); ExportSection still >500. Remaining: analysis export (+ JSON if needed), then SettingsScreen / useDailyEntryFormState / AddMealDialog / TodayScreen. One commit per split. |
