...
| [#936](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/936) | 🔍 Pending validation | Complete the day chart: dashed week and 500 g grid | Dashed CartesianGrid: vertical line each week, horizontal every 500 g. Awaiting on-device confirmation. |
