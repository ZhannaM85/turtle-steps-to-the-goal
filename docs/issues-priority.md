...
| [#899](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/899) | 🔍 Pending validation | Export: label next-morning weight with the actual date, not «next morning» | One-day CSV: «Weight YYYY-MM-DD» / «Вес …» for the next calendar morning. |
