...
| [#577](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/577) | ⬜ Open | Goal: put pace/calories mismatch hint in a light orange card | Follow-up to #574 — muted mismatch text looked like no change on-device; light orange warning card for visibility. |
