...
_Day page weekly-goal completed modal; barcode scanner; complete-week celebration; Settings food list; since-last-meal timer._
...
| [#793](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/793) | 🔲 Open | Day: align fasting-window note with Meals header | Extra horizontal padding insets the note vs «Приёмы пищи». |
