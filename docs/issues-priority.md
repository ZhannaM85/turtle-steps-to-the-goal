...
| [#63](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/63) | 🔲 Not started | Add a release notes section to Settings, updated per issue closure | Static in-repo data file (not a GitHub API fetch); CLAUDE.md's issue-close rule gets a 3rd required step |
