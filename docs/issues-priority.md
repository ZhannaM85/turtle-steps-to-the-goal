...
| [#800](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/800) | 🔍 Pending validation | Add dish: restrict kcal and macros to one decimal place | Follow-up to #799: `NumberField` on Add dish now caps kcal/protein/fat/carbs/fiber at 1 decimal (extra digits ignored while typing; paste rounded). Quantity / electrolytes unchanged. |
