...
| [#595](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/595) | ⬜ Open | Settings: confirm applying new default meal times to existing untimed meals | Follow-up to #580/#588. After editing slot defaults, confirm whether to stamp `timeEaten` on existing meals without a time. |
