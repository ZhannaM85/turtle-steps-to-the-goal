...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#918](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/918) | 🔍 Pending validation | PDF diary export: blank page appears between Food and Water | Tightened the styled-page fit limit to stay inside the PDF printable area and avoid a nearly blank image slice; regression test covers Food followed by Water at the prior boundary. Awaiting on-device PDF confirmation. |
