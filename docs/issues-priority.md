...
| [#934](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/934) | 📋 Not started | Day: Complete the day 5-week weight projection | Overlay from Day: if today's calories continued, show a 5-week weight line (TDEE vs intake, ~7700 kcal/kg). Close with X. |
