...
| [#883](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/883) | 📋 Not started | Body composition: visceral fat is shifted vs the other four metrics | Live: collapsed grid parks visceral fat top-center (`grid-cols-3`). Align with muscle / water / bone / fat. |
| [#884](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/884) | 📋 Not started | Day date Russian label is jammed without spaces | Live follow-up to #882: `13сентяб.2026г.` instead of `13 сент. 2026 г.` Overlay likely clipping. Same row as #885. |
| [#885](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/885) | 📋 Not started | Day: date input vs arrows height mismatch (regression of #809 / #647) | Live after #882 `DateInput`. Same lineage as #420 / #647 / #809 (`py-1` + WebKit exception). Do not re-break iOS height. |
| [#886](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/886) | 📋 Not started | Info tooltip sits too far from the info icon | Live: weight / fat comparison + body-comp screenshot tips. #872 `size-11` trigger vs `size-3.5` glyph; popover anchors to the 44px box. |
