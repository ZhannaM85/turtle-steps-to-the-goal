...
| [#868](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/868) | 📋 Not started | Split remaining Day/export/settings god files (≤500) | Follow-up to #864 lint. ExportSection + SettingsScreen + useDailyEntryFormState off the max-lines allowlist. Remaining: AddMealDialog, TodayScreen. One commit per split. |
