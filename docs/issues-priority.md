...
| [#921](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/921) | 🔍 Pending validation | PDF summary export: arrange compact metric cards two per row | Summary metric cards use two columns; charts and weekly-averages tables remain full width. Continuation sheets retain the grid. Awaiting on-device PDF confirmation. |
