...
| [#919](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/919) | 🔲 Open | PDF diary export: reduce or remove repeated page disclaimer | User suggests removing the repeated disclaimer or placing it in a smaller page footer; choose treatment at implementation. Screenshot: `photo_2026-09-16_10-27-37.jpg`. |
