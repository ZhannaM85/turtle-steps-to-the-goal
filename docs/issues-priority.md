...
| [#751](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/751) | 📋 Not started | Export sleep as hours and minutes, not decimal hours | CSV/Excel/Markdown print `10h 33m` not `10.55` (AutoSleep 17 Aug 2026: 10,55 ч / 3,43 ч). Same h+m preference as #707. JSON backup stays numeric. |
