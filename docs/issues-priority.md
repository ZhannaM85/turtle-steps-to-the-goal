...
| [#30](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/30) | ⬜ Open | Reorder daily entry form: Weight, Note, Log/Update button before Calories | "Log entry" currently sits right after Calories, reading as if it belongs to meal logging. Move Note + submit button to right after Weight, Calories section last |
