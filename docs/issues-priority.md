...
| [#927](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/927) | 📋 Not started | PDF diary: align meal card dividers within each card | The item divider in a compact meal card can extend upward into the preceding row. Keep it inside and aligned with its item text. |
