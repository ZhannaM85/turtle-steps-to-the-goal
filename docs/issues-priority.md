...
| [#916](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/916) | ⬜ Open | PDF export: reuse the shared export-period preset control | Use Week / Month / Year / All / Custom consistently with the other export formats instead of separate 30/90-day buttons. |
