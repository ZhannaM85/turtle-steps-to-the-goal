...
| [#928](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/928) | 📋 Not started | PDF export: vertically center page, section, and table headers | Center text vertically in dated page headers, colored section headers, and summary-table header and body cells. |
