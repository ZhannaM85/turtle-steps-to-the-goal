...
| [#920](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/920) | 🔲 Open | PDF diary export: day starts partway down a page | Next date heading appears below the prior day's Notes instead of starting a new page. Follow-up to #909; #917 remains pending validation. Same screenshot as #919. |
| [#921](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/921) | 🔲 Open | PDF summary export: arrange compact metric cards two per row | Make each card half the printable page width so two cards can share a row. Screenshots: `codex-clipboard-67cd40cb-91ec-42fb-af22-a93beeec4c56.png`, `codex-clipboard-5dccfd65-0714-4826-9ba6-2243714937c3.png`. |
