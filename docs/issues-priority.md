...
| [#677](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/677) | ⬜ Open | Regression from #674: delete active goal should pop stack to previous goal | **User clarification (2026-08-10):** goals are a stack — new goal on top; delete pops it; **previous goal** (e.g. Aug 4–9 0.2 kg under Aug 10–16 0.3 kg) must show again immediately **and after refresh**. Not empty create form; not «keep deleted forever». Persist `skipPromotingNextActive` (8508f96) was **wrong** (opposite of stack) and regressed #674. Undo that approach; make delete = remove top + show next-newest remaining as active/view. |
