...
| [#596](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/596) | ⬜ Open | Dashboard correlation charts: one decimal on X and Y axis ticks | User: exactly one digit after the decimal on both axes; do not close #592/#593 for this. |
