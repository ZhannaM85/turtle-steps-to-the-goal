...
| [#883](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/883) | 🔍 Pending validation | Body composition: visceral fat is shifted vs the other four metrics | Collapsed live grid is `grid-cols-2` — same pairing as edit (muscle\|visceral, water\|bone, fat). |
