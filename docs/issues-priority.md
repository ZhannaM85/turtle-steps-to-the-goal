...
| [#824](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/824) | 🔍 Pending validation | Chore: clear open Dependabot npm alerts (sharp, minimatch, uuid, elliptic) | Overrides: `sharp` 0.35.3, `minimatch` 3.1.4 (replace), `uuid` 11.1.1 (incl. xcode), `elliptic` → `@mapped/elliptic@6.6.8` (no upstream patch), plus `qs` 6.16.0. `npm audit` 0. |
