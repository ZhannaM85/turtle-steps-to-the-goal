...
| [#305](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/305) | 🔍 Pending validation | Adopt Capacitor to wrap the app for native iOS/Android builds | Foundational — everything else in this tier depends on it. Implemented and verified on a local Android emulator (Today screen renders, weight entry survives force-stop + relaunch); iOS generated but unverified, needs Xcode/Mac. Awaiting on-device confirmation |
