...
| [#960](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/960) | ⬜ Open | PDF: stop stretching short pages to full A4; Заметки white-gap still broken | Failed on-device validation 2026-09-17: the requested result is not fully addressed. Needs correction before another device check. |
