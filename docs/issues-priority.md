...
| [#23](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/23) | ⬜ Open | Add an About page — what this project is and who made it | Blocked on author bio/project copy; open question on nav placement (recommend linking from Settings, not a new bottom tab) |
