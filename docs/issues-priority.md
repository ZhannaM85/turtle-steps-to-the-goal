...
| [#588](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/588) | ⬜ Open | Import: let user set Breakfast/Lunch/Snack/Dinner default times (not hardcoded) | Follow-up to #580. Prompt or inputs on import for slot defaults (user: 12:00 / 15:00 / 18:00 / 21:00); prefer remembered prefs over fixed clocks. |
