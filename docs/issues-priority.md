...
| [#596](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/596) | 🔍 Pending validation | Dashboard correlation charts: one decimal on X and Y axis ticks | `formatCorrelationScatterTick` + Y width 52 on all correlation scatters; HH:mm / Yes-No X unchanged. |
