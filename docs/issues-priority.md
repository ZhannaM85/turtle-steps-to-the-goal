...
| [#800](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/800) | 🔍 Pending validation | Add dish: restrict kcal and macros to two decimal places | Follow-up to #799: `NumberField` on Add dish caps kcal/protein/fat/carbs/fiber at 2 decimals (extra digits ignored while typing; paste rounded). Raised from 1 to 2 on 2026-09-02 after live feedback. Quantity / electrolytes unchanged. |
