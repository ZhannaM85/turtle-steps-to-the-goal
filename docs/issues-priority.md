...
| [#26](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/26) | ⬜ Open | Favicon reads as a 6-pointed star, not a turtle — redesign | Follow-up to #22; top-down radial-symmetry design misreads as a star at 16-32px. Open questions on color (teal vs. green) and detail level to settle before implementing |
