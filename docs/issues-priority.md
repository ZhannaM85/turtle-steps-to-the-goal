...
| [#82](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/82) | 🔲 Open | Time-eaten field should not be pre-populated | Reverses #65's "defaults to now" decision — reads as an already-confirmed value, not a prompt. Plan: add-flow Time input starts empty, same as the other add-* fields |
