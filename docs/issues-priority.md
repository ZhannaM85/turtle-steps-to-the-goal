...
| [#783](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/783) | 📋 Not started | Complete-week celebration: show only after saving weight, not on every app open | On-device 2026-08-30 after #778: modal on every app reopen with 60,2 кг already saved. Should fire only on weight save; dismiss stays closed across restarts; save again (or delete+log) can show it until a new goal. |
