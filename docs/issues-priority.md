...
| [#922](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/922) | 🔍 Pending validation | PDF diary export: improve local generation speed for weekly diaries | Reduced each standard PDF page canvas from 2x to 1.5x resolution, cutting render pixels by about 44% while retaining ~144dpi output. Awaiting on-device PDF confirmation. |
