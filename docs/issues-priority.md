...
| [#920](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/920) | 🔍 Pending validation | PDF diary export: day starts partway down a page | Each date now owns a starting PDF sheet, while a long day's cards can continue onto later sheets. Awaiting on-device PDF confirmation. |
