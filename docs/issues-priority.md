...
| [#913](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/913) | 🔍 Pending validation | PDF diary Food section: move consumed total into the section header | Put the kcal and macro summary in the Food header before meal details. |
| [#914](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/914) | 🔍 Pending validation | PDF export section picker: keep info icons beside their labels | Keep each info icon adjacent to the section label it explains, with consistent spacing. |
| [#915](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/915) | 🔍 Pending validation | PDF export: add a colorful, print-friendly visual theme | Use restrained section colors, accents, and backgrounds while preserving readability and iOS Safari capture reliability. |
| [#916](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/916) | 🔍 Pending validation | PDF export: reuse the shared export-period preset control | Use Week / Month / Year / All / Custom consistently with the other export formats instead of separate 30/90-day buttons. |
