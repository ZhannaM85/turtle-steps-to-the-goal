...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#659](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/659) | 🔨 In progress | Goal: let the user edit the weekly window's end date | New optional `Goal.weekEnd`, defaults to `weekStart+6` (unchanged default), editable on the goal form to any date on/after the window's start |
