...
| [#868](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/868) | 📋 Not started | Split remaining Day/export/settings god files (≤500) | Follow-up to #864 lint. ExportSection + SettingsScreen + useDailyEntryFormState + AddMealDialog off the max-lines allowlist. Remaining: TodayScreen. One commit per split. |
