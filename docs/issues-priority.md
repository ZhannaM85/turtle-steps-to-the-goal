...
| [#927](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/927) | 🔍 Pending validation | PDF diary: align meal card dividers within each card | Meal-card item dividers now have their own contained layout box and cannot paint beyond their card boundary. Awaiting device PDF validation. |
...
| [#929](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/929) | 📋 Not started | PDF diary: reduce Metrics and Notes body text size | Device preview shows the Показатели and Заметки body text remains too large and consumes too much page height. Logged only; no implementation started. |
| [#930](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/930) | 📋 Not started | PDF diary: show total water beside the Water title | Move the total water amount from the section body to the Вода title for a more compact diary layout. Logged only; no implementation started. |
| [#931](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/931) | 📋 Not started | PDF diary: replace unclear steps icon with a text label | The walking figure is unclear in device previews; show the localized Шаги label beside the count instead. Logged only; no implementation started. |
