...
| [#877](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/877) | 🔍 Pending validation | Settings: group ~29 peer cards instead of one flat scroll | Five named groups (Logging / Display / Library / Backup / Danger) with per-group collapse. Pin still lifts a card above the groups. Collapse-all is `min-h-11`. |
