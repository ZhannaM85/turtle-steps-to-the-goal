...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#836](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/836) | 🔍 Pending validation | Day: meal vs-yesterday kcal arrows (same label) + Settings toggle | Match meal label vs yesterday; under macros; kcal only; green less / red more; Settings toggle; screenshots in discussion. Default ON to match entry comparisons (#664). |
