...
Vitest + jsdom + `fake-indexeddb` + React Testing Library + `@testing-library/user-event`. **363 tests across 55 files**, all passing as of issue #68.
