...
Vitest + jsdom + `fake-indexeddb` + React Testing Library + `@testing-library/user-event`. **358 tests across 55 files**, all passing as of issue #60.
