...
Vitest + jsdom + `fake-indexeddb` + React Testing Library + `@testing-library/user-event`. **355 tests across 55 files**, all passing as of issue #59.
