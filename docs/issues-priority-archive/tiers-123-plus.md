...
| [#778](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/778) | ✅ Done | Complete-week celebration: keep offering until the next goal is set | Confirmed on-device 2026-08-30 after #783 — can show again until the next goal; not on every app open. |
| [#779](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/779) | ✅ Done | Settings: manually add a barcode to a food that was saved earlier | Confirmed on-device 2026-08-30 — barcode field on existing foods. Persist-after-save is #784. |
| [#780](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/780) | ✅ Done | Settings food list: pencil should become save while editing | Confirmed on-device 2026-08-30 — pencil becomes a check in edit; tap saves. |
| [#781](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/781) | ✅ Done | Settings food list: add a brand field on an existing food | Confirmed on-device 2026-08-30 — brand field on existing foods; shown on the list when set. |
| [#782](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/782) | ✅ Done | Settings food list: expand the food name field while editing | Confirmed on-device 2026-08-30 — name uses the full row while editing. |
| [#783](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/783) | ✅ Done | Complete-week celebration: show only after saving weight, not on every app open | Confirmed on-device 2026-08-30 — modal after weight save, not on every app open. |
| [#784](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/784) | ✅ Done | Settings: barcode typed on an existing food does not stay after save | Confirmed on-device 2026-08-30 — unique barcode persists; if another food already has the code, the editor names that food instead of dropping it. |
| [#785](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/785) | ✅ Done | Settings: move a taken barcode onto this food, then open the other food | Confirmed on-device 2026-08-30 — move barcode here, then open the leftover food to delete it. |
| [#786](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/786) | ✅ Done | Settings: barcode-moved banner still offers to open a food after it is deleted | Closed 2026-08-30 without on-device check — no leftover-food-after-move scenario left to reproduce. Will reopen if the banner still appears after that food is deleted. |
| [#787](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/787) | ✅ Done | Settings: confirm before deleting a saved food | Confirmed on-device 2026-08-30 — trash asks to confirm; Cancel keeps the food. Past meals with that name stay. |
| [#788](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/788) | ✅ Done | Scan then edit creates a new food without the barcode instead of updating the existing one | Confirmed on-device 2026-08-30 — scan then edit updates that food in place instead of creating a barcode-less copy. |
| [#789](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/789) | ✅ Done | Settings: search saved foods by barcode | Confirmed on-device 2026-08-30 — typing barcode digits finds the food; placeholder says name or barcode. |
| [#790](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/790) | ✅ Done | Settings: clear icon on saved-foods search | Confirmed on-device 2026-08-30 — X in the search field clears the query. |
| [#791](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/791) | ✅ Done | Day: live timer since last meal (intermittent fasting) | Confirmed on-device 2026-08-30 — timer between last meal and Add meal; Settings toggle. |
| [#792](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/792) | ✅ Done | Day: show hours since previous meal on each meal card | Confirmed on-device 2026-08-30 — hours+minutes under each meal title; same Settings toggle as #791. |
...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#828](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/828) | ✅ Done | Goal: last-day weight gain still marks the week completed | Confirmed on-device 2026-09-09 — last-day weight gain marks the week missed (not completed); no complete-week celebration. |
...
| [#842](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/842) | ✅ Done | Day: Night food No — replace thoughts with What helped? | Confirmed on-device 2026-09-10 — Night food No uses «Что помогло?» / «What helped?» instead of thoughts. |
...
| [#840](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/840) | ✅ Done | Day: note input + save checkmark height and vertical align | Confirmed on-device 2026-09-10 — note input and save checkmark height/align fixed. |
| [#841](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/841) | ✅ Done | Day: note field placeholder should be vertically centered | Confirmed on-device 2026-09-10 — empty note placeholder vertically centered. |
| [#843](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/843) | ✅ Done | New meal pre-fills custom title from prior day | Confirmed on-device 2026-09-10 — new meals no longer prefill free-text custom titles from yesterday; templates only. |
| [#844](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/844) | ✅ Done | New meal still defaults to «Обед» when lunch already logged today | Confirmed on-device 2026-09-10 — new meal skips already-used titles (no longer defaults to «Обед» when lunch is logged). |
...
| [#878](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/878) | ✅ Done | Tokenize semantic status colors (reason dots, good/bad, Goal warning) | Confirmed on-device 2026-09-14 — reason dots, good/warn, Goal overlap use status tokens. |
| [#877](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/877) | ✅ Done | Settings: group ~29 peer cards instead of one flat scroll | Confirmed on-device 2026-09-14 — five groups, pin, per-group collapse, Collapse all tap target. |
| [#876](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/876) | ✅ Done | Day accordion recipe: headers, stats nesting, redundant page blurb | Confirmed on-device 2026-09-14 — shared SectionAccordion, no double-boxed stats, Day blurb gone. |
| [#881](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/881) | ✅ Done | Pace check copy reads as a loss when weight went up | Confirmed on-device 2026-09-14 — gained/lost/stayed the same with unsigned kg/week. |
| [#875](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/875) | ✅ Done | Unify confirm, undo, and discard bars | Confirmed on-device 2026-09-14 — shared NoticeBar chrome; water-chip hide follow-up filed. |
| [#874](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/874) | ✅ Done | One Chip primitive for water, meal names, and History legend | Confirmed on-device 2026-09-14 — shared Chip on water, meal templates, History legend. |
| [#873](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/873) | ✅ Done | Settings cards still use number-card chrome; titles collide with pin | Confirmed on-device 2026-09-14 — section-shell panels; titles clear of pin/collapse. |
| [#872](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/872) | ✅ Done | Title-row icon actions stay under 44pt after #858 | Confirmed on-device 2026-09-14 — icon-touch on Day headers, Settings pin, water ×, ⓘ. |
...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#908](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/908) | ✅ Done | PDF export: CSS styling missing on pages after the first two | Confirmed on-device 2026-09-15 — diary pages retain styled date and section cards on later pages. |
...
| [#921](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/921) | ✅ Done | PDF summary export: arrange compact metric cards two per row | Confirmed on-device 2026-09-16. Follow-up 2026-09-17: explicit left/right columns keep vertical spacing even. |
...
| [#925](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/925) | ✅ Done | PDF diary export: optimize spacing after Night food notes | Confirmed on-device 2026-09-16. Follow-up 2026-09-17: larger meal text, roomier card padding, and explicit columns keep spacing consistent. |
...
| [#927](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/927) | ✅ Done | PDF diary: align meal card dividers within each card | Confirmed on-device 2026-09-17 — meal-item dividers align cleanly within each card. |
| [#928](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/928) | ✅ Done | PDF export: vertically center page, section, and table headers | Confirmed on-device 2026-09-17 — page, section, and table headers are vertically centered. |
| [#929](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/929) | ✅ Done | PDF diary: reduce Metrics and Notes body text size | Confirmed on-device 2026-09-17 — Metrics and Notes body text size looks good. |
| [#930](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/930) | ✅ Done | PDF diary: show total water beside the Water title | Confirmed on-device 2026-09-17 — the total water amount sits correctly beside the Water title. |
| [#932](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/932) | ✅ Done | PDF diary: footer still cut off, generated date not visible | Confirmed on-device 2026-09-17 — PDF footer and generated date are visible. |
...
| [#933](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/933) | ✅ Done | PDF layout preview route for browser inspection | Confirmed on-device 2026-09-17 — the PDF layout preview route opens and displays the generated pages. |
...
| [#935](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/935) | ✅ Done | PDF layout preview cannot predict the iOS PDF | Confirmed on-device 2026-09-17 — preview uses the same captured rendering path as the exported PDF. |
...
| [#937](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/937) | ✅ Done | Complete the day chart: lighten the dashed grid | Confirmed on-device 2026-09-17 — the dashed chart grid has the intended lighter appearance. |
| [#938](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/938) | ✅ Done | Complete the day chart: x-axis labels are cut off | Confirmed on-device 2026-09-17 — the chart’s start and end labels stay inside the plot. |
...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#942](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/942) | ✅ Done | PDF summary: widen Неделя column so week ranges stay on one line | Confirmed on-device 2026-09-17 — weekly date ranges stay on one line. |
| [#943](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/943) | ✅ Done | Export: keep info icons tight beside buttons (CSV and other rows) | Confirmed on-device 2026-09-17 — Export info icons stay close to their controls. |
| [#944](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/944) | ✅ Done | Day: lighten Завершить день to match Начать сегодняшний день сейчас | Confirmed on-device 2026-09-17 — the Complete day action uses the intended lighter styling. |
...
| [#952](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/952) | ✅ Done | PWA: Settings button to toggle PDF pdfDebug overlay | Confirmed on-device 2026-09-17 — the Settings PDF debug toggle controls the diagnostic overlay. |
...
| [#941](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/941) | ✅ Done | PDF diary: match Показатели header to other section headers | Confirmed on-device 2026-09-17 — Показатели header matches Еда / Вода / Заметки. Follow-up #962 moves mood out of the header. |
| [#940](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/940) | ✅ Done | PDF diary: increase meal item and water log fonts by 2pt | Confirmed on-device 2026-09-17 — meal item and water log fonts look good. |
| [#960](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/960) | ✅ Done | PDF: stop stretching short pages to full A4; Заметки white-gap still broken | Confirmed on-device 2026-09-17 — diary layout looks good with footer pinning; natural-aspect approach (`b98579a89`) was reverted. |
| [#958](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/958) | ✅ Done | PDF diary: footer gone, water gap, notes detached (regression after #939 fill removal) | Confirmed on-device 2026-09-17 — footer, water, and notes layout look good. |
| [#939](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/939) | ✅ Done | PDF diary: excessive blank band below the footer | Confirmed on-device 2026-09-17 — blank band below the footer is resolved. |
| [#961](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/961) | ✅ Done | PDF export: restore preview before Save or Share | Confirmed on-device 2026-09-17 — export opens the PDF preview first; Share/Save come from the viewer. |
...
| [#966](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/966) | ✅ Done | Settings: remove collapse control on О проекте card | Confirmed on-device 2026-09-18 — the About card stays expanded without a collapse control. |
| [#965](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/965) | ✅ Done | Day: remove optional-fields subheader under morning and evening sections | Confirmed on-device 2026-09-18 — optional-fields subheaders are removed from the Morning and Evening sections. |
...
| [#973](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/973) | ✅ Done | Bottom footer/nav disappears while scrolling, reappears on scroll release | Confirmed on-device 2026-09-26 — tab bar no longer hides on finger pan; superseding always-visible approach is #974. |
| [#974](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/974) | ✅ Done | Bottom nav: match my-money — always visible, no visualViewport hide | Confirmed on-device 2026-09-26 — tab bar always mounted; no visualViewport hide/unmount. |
...
_AutoSleep screenshot scan left deep sleep empty when the circled-z row was a whole number of hours. Edit meal / QR share defaults Количество to 100 г. Share multiple foods via one QR or link. Create a recipe from selected meal foods._
...
| [#982](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/982) | ✅ Done | Share multiple foods at once via one QR code or link | Confirmed on-device 2026-09-26 — section share encodes the meal composition as one `?shareFood=` link; recipient can add all. |
...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#986](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/986) | ✅ Done | Create recipe: warn when selected ingredients already exist as recipes + copy name | Confirmed on-device 2026-09-26 — lists selected dishes that match a saved recipe name; «Скопировать название» fills the title. |
| [#987](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/987) | ✅ Done | Create recipe: after save, offer to add recipe and replace selected ingredients | Confirmed on-device 2026-09-26 — after save, «Добавить» replaces selected foods with one recipe serving; «Не добавлять» leaves the meal as-is. |
| [#988](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/988) | ✅ Done | Create recipe: warn when the same foods, or the typed title, already exist as a recipe | Confirmed on-device 2026-09-26 — warns for matching ingredient set or typed title; name-match list and copy-name stay. |
...
| [#995](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/995) | ✅ Done | Meal search: one row for the same name and macros, long-press delete | Confirmed on-device 2026-09-26 — identical name+macros collapse to one row; long-press delete with confirm. Per-100 г twin fix follow-up: #1006. |
| [#996](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/996) | ✅ Done | Add food: not scrollable until first food / Готово appears | Confirmed on-device 2026-09-26 — empty add-food sheet scrolls before the first dish / Готово footer. |
