...
| [#827](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/827) | ✅ Done | Settings: export week/month/year should be past periods ending today | Confirmed on-device 2026-09-08 — week/month/year are trailing periods ending today. Follow-up: All date inputs empty and filename is today only. |
