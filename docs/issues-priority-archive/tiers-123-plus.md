...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#829](https://github.com/ZhannaM85/turtle-steps-to-the-goal/issues/829) | ✅ Done | Day: Next Morning Weight card from the following day's weigh-in | Confirmed on-device 2026-09-08 — card shows D+1 weight and signed delta. Follow-up #831: Night food and Next Morning Weight are not collapsible. Follow-up #832: one-day export header is the key `next_morning_weight` instead of the translated label. |
