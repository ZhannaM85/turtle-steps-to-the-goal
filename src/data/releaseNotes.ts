...
export const releaseNotes: ReleaseNote[] = [
  ...
  },
  {
    ...
    en: 'An AutoSleep screenshot now fills deep sleep when that value is a whole number of hours, such as 3h 0m.',
    ru: 'Скриншот AutoSleep теперь заполняет глубокий сон, если там целое число часов, например 3 ч 0 м.',
  },
  {
    version: 954,
    issue: 979,
  ...
  },
  {
    ...
    en: 'PDF diary pages no longer leave a large empty band under the footer — the disclaimer sits with a normal bottom margin.',
    ru: 'В дневнике PDF больше нет большой пустой полосы под футером — дисклеймер стоит с обычным нижним полем.',
  },
  {
    version: 924,
    issue: 955,
  ...
  },
  {
    ...
    en: 'PDF day, section, and weekly table text now stays vertically centered in captured pages.',
    ru: 'Текст дат, разделов и недельной таблицы PDF теперь остаётся выровненным по вертикальному центру на готовых страницах.',
  },
  {
    version: 900,
    issue: 938,
  ...
  },
  {
    ...
    en: 'In PDF diary exports, each day starts on a new page instead of wrapping under the previous date.',
    ru: 'В PDF-дневнике каждый день начинается с новой страницы, а не продолжается под предыдущей датой.',
  },
  {
    version: 861,
    issue: 907,
  ...
  },
  {
    ...
    en: 'Daily exports label the day note as Evening note, with the date on one-day files.',
    ru: 'В ежедневном экспорте заметка дня называется «Вечерняя заметка», а в файле за один день указана дата.',
  },
  {
    version: 852,
    issue: 894,
  ...
  },
  {
    ...
    en: 'Day-share CSV also includes that day’s calorie and macro targets next to intake.',
    ru: 'В CSV «Отправить день» рядом с фактом тоже стоят цели по калориям и БЖУ на этот день.',
  },
  {
    version: 852,
    issue: 895,
  ...
  },
  {
    ...
    en: 'Settings groups use the same quiet panel style as charts, and titles no longer run under the pin.',
    ru: 'Группы в Настройках в той же спокойной рамке, что и графики, и заголовок больше не заходит под кнопку закрепления.',
  },
  {
    version: 824,
    issue: 872,
  ...
  },
  {
    ...
    en: 'Choosing No on Night food now lets you add whether it was easy and any thoughts — those answers are included in backups and Daily Log exports.',
    ru: 'Если на карточке «Ночная еда» выбрать Нет, можно отметить, было ли легко, и записать мысли — эти ответы входят в резервные копии и экспорт дневника.',
  },
  {
    version: 794,
    issue: 833,
  ...
  },
  {
    ...
    en: 'Hours since the previous meal under each meal name is a bordered badge, with padding so the time is not flush to the edge.',
    ru: 'Время с предыдущего приёма под названием еды — бейдж с рамкой и отступами, чтобы цифры не прилипали к краю.',
  },
  {
    version: 756,
    issue: 795,
  ...
  },
  {
    ...
    en: 'A day’s log can now be packed into a small snippet for another Turtle Steps copy (sleep, weight, meals, and the rest). Sending and receiving from the Day screen comes next.',
    ru: 'Запись за день теперь можно упаковать в короткий сниппет для другой копии Turtle Steps (сон, вес, еда и остальное). Отправка и приём с экрана «День» будут следующим шагом.',
  },
  {
    version: 684,
    issue: 738,
  ...
  },
  {
    version: 658,
    issue: 697,
    date: '2026-08-12T22:35:22+03:00',
  ...
  },
  {
    version: 655,
    issue: 695,
    date: '2026-08-11T16:27:00+03:00',
  ...
  },
  {
    ...
    en: 'Sync from Health Connect now refreshes today’s weight even if one was already logged — tap Sync again after updating the source.',
    ru: 'Синхронизация с Health Connect теперь обновляет вес за сегодня, даже если он уже был введён — нажмите снова после обновления в источнике.',
  },
  {
    version: 650,
    issue: 692,
