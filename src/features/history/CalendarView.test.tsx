...
describe('CalendarView', () => {
  ...
  it('marks the calendar day as today after midnight (#984)', () => {
    vi.useFakeTimers()
    ...
    expect(screen.getByRole('button', { name: aug3Label })).toHaveAttribute(
      'aria-current',
      'date',
    )
    expect(
      screen.getByRole('button', { name: aug2Label }),
