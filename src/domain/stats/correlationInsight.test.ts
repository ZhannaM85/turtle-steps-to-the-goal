...
describe('correlationInsight', () => {
  ...
  it('returns null with fewer than 4 comparable weeks', () => {
    const entries = [
      ...
      entry(weekStart(2), { weightKg: 86, caloriesConsumed: 2200 }),
    ]
  ...
  it('reports the lower-calorie half averaging more loss', () => {
    const entries = [
      entry(weekStart(0), { weightKg: 90 }),
      entry(weekStart(1), { weightKg: 88, caloriesConsumed: 1700 }), // delta -2
      entry(weekStart(2), { weightKg: 86, caloriesConsumed: 1800 }), // delta -2
      entry(weekStart(3), { weightKg: 85.5, caloriesConsumed: 2200 }), // delta -0.5
      entry(weekStart(4), { weightKg: 85.3, caloriesConsumed: 2300 }), // delta -0.2
    ]
  ...
  it('reports the higher-calorie half averaging more loss when that is what the data shows', () => {
    const entries = [
      entry(weekStart(0), { weightKg: 90 }),
      entry(weekStart(1), { weightKg: 89.8, caloriesConsumed: 1700 }), // delta -0.2
      entry(weekStart(2), { weightKg: 89.5, caloriesConsumed: 1800 }), // delta -0.3
      entry(weekStart(3), { weightKg: 87.5, caloriesConsumed: 2200 }), // delta -2
      entry(weekStart(4), { weightKg: 85.5, caloriesConsumed: 2300 }), // delta -2
    ]
  ...
  it('rounds the threshold to the nearest 50 kcal', () => {
    const entries = [
      entry(weekStart(0), { weightKg: 90 }),
      entry(weekStart(1), { weightKg: 88, caloriesConsumed: 1810 }),
      entry(weekStart(2), { weightKg: 86, caloriesConsumed: 1830 }),
      entry(weekStart(3), { weightKg: 85, caloriesConsumed: 2210 }),
      entry(weekStart(4), { weightKg: 84, caloriesConsumed: 2230 }),
    ]
