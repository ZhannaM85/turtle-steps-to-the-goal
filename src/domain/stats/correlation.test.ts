...
describe('correlation', () => {
  ...
  it('returns null with a single data point (only one week, no delta possible)', () => {
    const entries = [
      entry(weekStart(0), { weightKg: 80, caloriesConsumed: 2000 }),
    ]
  ...
  it('returns null when there is only one comparable week (two weeks total)', () => {
    const entries = [
      ...
      entry(weekStart(1), { weightKg: 87, caloriesConsumed: 1800 }),
    ]
  ...
  it('returns null when calories have no variance', () => {
    const entries = [
      entry(weekStart(0), { weightKg: 90 }),
      entry(weekStart(1), { weightKg: 87, caloriesConsumed: 2000 }),
      entry(weekStart(2), { weightKg: 84, caloriesConsumed: 2000 }),
    ]
  ...
  it('returns null when weight change has no variance', () => {
    const entries = [
      entry(weekStart(0), { weightKg: 90 }),
      entry(weekStart(1), { weightKg: 87, caloriesConsumed: 1800 }),
      entry(weekStart(2), { weightKg: 84, caloriesConsumed: 2200 }),
    ]
  ...
  it('returns +1 for a perfectly linear relationship (more calories, less loss)', () => {
    const entries = [
      entry(weekStart(0), { weightKg: 90 }),
      entry(weekStart(1), { weightKg: 87, caloriesConsumed: 1800 }), // delta -3
      entry(weekStart(2), { weightKg: 85, caloriesConsumed: 2000 }), // delta -2
      entry(weekStart(3), { weightKg: 84, caloriesConsumed: 2200 }), // delta -1
    ]
  ...
  it('returns -1 for a perfectly linear inverse relationship (more calories, more loss)', () => {
    const entries = [
      entry(weekStart(0), { weightKg: 90 }),
      entry(weekStart(1), { weightKg: 87, caloriesConsumed: 2200 }), // delta -3
      entry(weekStart(2), { weightKg: 85, caloriesConsumed: 2000 }), // delta -2
      entry(weekStart(3), { weightKg: 84, caloriesConsumed: 1800 }), // delta -1
    ]
