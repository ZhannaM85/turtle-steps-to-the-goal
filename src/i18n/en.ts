...
export const en: Dictionary = {
  ...
  dailyEntry: {
    ...
    nightEatingNoThoughtsLabel: 'Any thoughts?',
    nightEatingNoThoughtsFieldPlaceholder: 'Anything you want to remember',
    saveNightEatingNoThoughtsLabel: 'Save thoughts',
    editNightEatingNoThoughtsLabel: 'Edit thoughts',
    cancelEditNightEatingNoThoughtsLabel: 'Cancel editing thoughts',
  ...
  exportXlsx: {
    ...
    nightEatingNoThoughtsColumn: 'Night food thoughts',
