...
export const ru: Dictionary = {
  ...
  about: {
    ...
    intro:
      '«Черепашьи шаги к цели» — небольшое личное приложение для отслеживания веса. В основе — одна идея: перемены происходят через маленькие, уверенные шаги, а не через большие цели, которые давят.',
    philosophy:
