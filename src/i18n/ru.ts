...
export const ru: Dictionary = {
  ...
  settings: {
    ...
    localTransferLabel: 'Отправка в другую копию',
    localTransferDescription:
      'Скопировать записанный приём пищи в другое приложение Turtle Steps на этом телефоне или на другом устройстве (буфер, «Поделиться» или QR). Большинству достаточно одной копии — оставьте выключенным. Включайте в каждой копии, которая должна отправлять или принимать.',
    localTransferOn: 'Вкл',
