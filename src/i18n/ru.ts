...
export const ru: Dictionary = {
  ...
  today: {
    ...
    gOverProteinUnit: 'г больше нормы',
  ...
  dashboard: {
    ...
    fastingCutoffTitle: 'Сравнение по времени окончания еды',
    fastingCutoffEmptyDescription:
      'Пока недостаточно данных, чтобы увидеть закономерность — отмечайте время еды и продолжайте отслеживать вес, затем загляните сюда через несколько недель.',
    fastingCutoffSummary: (cutoffTime, direction) =>
      direction === 'after'
        ? `Дни, когда последний приём пищи был после ${cutoffTime}, в среднем показывали больший набор веса на следующее утро, чем дни, когда ели раньше.`
        : `Дни, когда последний приём пищи был до ${cutoffTime}, в среднем показывали больший набор веса на следующее утро, чем дни, когда ели позже.`,
    fastingCutoffDayCount: (n) =>
      `На основе ${n} ${ruPluralize(n, 'дня', 'дней', 'дней')} данных.`,
    fastingCutoffLagCaveat:
      'Проверяет фиксированное время отсечки напрямую — это не доказанная причинно-следственная связь: на вес изо дня в день также влияют задержка воды, соль и многие другие факторы.',
    fastingCutoffBeforeLabel: (cutoffTime) => `До ${cutoffTime}`,
    fastingCutoffAfterLabel: (cutoffTime) => `После ${cutoffTime}`,
  ...
  settings: {
    ...
    fastingCutoffLabel: 'Время окончания приёма пищи',
    fastingCutoffDescription:
      'Используется сравнением «еда после этого времени и до» на панели — измените, чтобы проверить любое время, не только 18:00.',
