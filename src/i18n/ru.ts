...
export const ru: Dictionary = {
  ...
  dailyEntry: {
    ...
    nightEatingNoThoughtsLabel: 'Какие мысли?',
    nightEatingNoThoughtsFieldPlaceholder: 'Что хочется запомнить',
    saveNightEatingNoThoughtsLabel: 'Сохранить мысли',
    editNightEatingNoThoughtsLabel: 'Изменить мысли',
    cancelEditNightEatingNoThoughtsLabel: 'Отменить редактирование мыслей',
  ...
  exportXlsx: {
    ...
    nightEatingNoThoughtsColumn: 'Мысли о ночной еде',
    waterColumn: 'Вода (мл)',
