...
export const ru: Dictionary = {
  ...
  settings: {
    ...
    healthConnectSyncDescription:
      'Синхронизировать вес и шаги из Health Connect за сегодня и несколько прошлых дней — включая данные, которые записали другие приложения. Каждая синхронизация подтягивает последние значения за день и обновляет приложение (можно нажать снова после изменения в источнике).',
    ...
    healthConnectSyncNoDataMessage:
      'В Health Connect нет веса или шагов за последние 7 дней.',
  ...
  privacyPolicy: {
    ...
    healthConnectPrivacyBody:
      'На Android нажатие «Синхронизировать из Health Connect» в настройках считывает недавние значения веса и суммы шагов (сегодня и несколько прошлых дней) из Health Connect — хранилища данных о здоровье Android на устройстве. Ничего не считывается автоматически, и ничего никогда не записывается обратно в Health Connect. Это происходит только при нажатии этой кнопки, требует вашего явного разрешения и считывает только вес и шаги. Синхронизированные значения хранятся локально, так же как и любая другая запись — см. «Где хранятся ваши данные» ниже.',
