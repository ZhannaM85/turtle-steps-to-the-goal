...
export const ru: Dictionary = {
  ...
  goal: {
    ...
    estimatePaceFromCaloriesButton: 'Оценить темп недели по этим калориям',
    estimatePaceFromCaloriesCaveat:
      'Обновляет недельный темп (и белки/жиры/углеводы) по дневной цели калорий относительно примерного поддержания — грубая оценка, не медицинская рекомендация. Проверьте перед сохранением.',
    estimatePaceFromCaloriesNeedCaloriesHint:
      'Введите дневную цель по калориям выше, чтобы оценить недельный темп.',
  ...
  settings: {
    ...
    dayStartDescription:
      'Когда начинается ваш день на экране «День» — всё, что записано до этого времени, засчитывается за предыдущий день. Влияет только на новые записи и пока только на экран «День» (серии, сводки и корреляции всё ещё используют реальную календарную дату). По умолчанию — полночь, что полностью соответствует текущей дате.',
